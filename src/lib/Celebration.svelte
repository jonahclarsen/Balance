...
<style>
  ...
  .presence-words { position: absolute; left: 50%; top: 63%; padding: .72em 1.05em .72em 1.32em; border: 1px solid color-mix(in srgb, var(--c1) 48%, white); border-radius: 999px; background: color-mix(in srgb, var(--c3) 92%, transparent); box-shadow: 0 10px 30px #273a3226, inset 0 1px #fff9; color: color-mix(in srgb, var(--c2) 68%, #17241f); font: 700 clamp(14px, 2.2vw, 22px)/1 system-ui; letter-spacing: .28em; text-shadow: 0 1px #fff8; white-space: nowrap; backdrop-filter: blur(10px) saturate(.75); transform: translateX(-50%); animation: presence-words 4.2s ease both; }
